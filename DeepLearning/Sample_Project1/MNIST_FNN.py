...
dataset = np.load('../.keras/datasets/MNIST/mnist.npz')
x_train, y_train, x_test, y_test = dataset['train'].T, dataset['train_labels'].T, dataset['test'].T, dataset['test_labels'].T
