...
x_train = np.array([unpickle('../.keras/datasets/CIFAR10/data_batch_'+str(i))[b'data'] for i in range(1,6)])
y_train = np.array([unpickle('../.keras/datasets/CIFAR10/data_batch_'+str(i))[b'labels'] for i in range(1,6)])
x_test = np.array(unpickle('../.keras/datasets/CIFAR10/test_batch')[b'data'])
y_test = np.array(unpickle('../.keras/datasets/CIFAR10/test_batch')[b'labels'])
